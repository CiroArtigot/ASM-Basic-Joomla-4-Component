 ...
 * @since  1.6
 */
class LeadModel extends ItemModel
{
    public $_item;
	...
	protected function populateState()
	{
		...
		if ((!$user->authorise('core.edit.state', 'com_algosemueve')) && (!$user->authorise('core.edit', 'com_algosemueve')))
		{
	...
	public function getItem($id = null)
	{
            if ($this->_item === null)
            {
                ...
                if ($table->load($id))
                {
                    ...
                    if ($published = $this->getState('filter.published'))
                    {
                        ...
                        {
                            throw new \Exception(Text::_('COM_ALGOSEMUEVE_ITEM_NOT_LOADED'), 403);
                        }
                    }
                ...
                if (empty($this->_item))
				{
					throw new \Exception(Text::_('COM_ALGOSEMUEVE_ITEM_NOT_LOADED'), 404);
				}
            }
		...
		if (isset($this->_item->catid) && $this->_item->catid != '')
		{
			...
			if ( !empty($this->_item->id) ) {
					...
					$ids = $tagsHelper->getTagIds($this->_item->id, 'com_algosemueve.lead');
	...
	public function getItemIdByAlias($alias)
	{
            ...
            {
            	$aliasKey   = $this->getAliasFieldNameByView('lead');
            }
